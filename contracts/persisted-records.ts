...
export function validateVersionDeploymentRecord(value: unknown): DeploymentRecordValidation {
	...
	return {
		ok: true,
		record: { v: 1, kind: "iweb-version-deployment", sandboxId: record.sandboxId, applicationId: record.applicationId, versionId: record.versionId, digest: record.digest, sequence: record.sequence, deployedAt: record.deployedAt as string },
	};
}
